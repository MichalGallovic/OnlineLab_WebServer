	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<div class="clearfix">
				...
				<a href="#" class="btn btn-info btn-xs pull-right" data-toggle="modal" data-target="#upload-modal">{{trans("controller::default.CTRL_UPLOAD_FILE")}}</a>
			</div>
		</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title">{{trans('controller::default.NEW_CONTROLLER_TITLE')}}</h4>
				</div>
				<div class="modal-body">
					{!! Form::open(array('method' => 'post', 'route' => 'controller.upload', 'id' => 'file-upload-form', 'files' => true)) !!}
					<div class="form-group {!! ($errors->has('title')) ? 'has-error' : '' !!}">
						{!! Form::label("title", trans("controller::default.CTRL_NAME"), ['class' => 'control-label']) !!}
					...
					<div class="form-group {!! ($errors->has('type')) ? 'has-error' : '' !!}">
						{!! Form::label("type", trans("controller::default.LABEL_TYPE_REGULATOR"), ['class' => 'control-label']) !!}
						{!! Form::select("type", ['private' => trans('controller::default.ACCES_PRIVATNY'), 'public' => trans('controller::default.ACCES_VEREJNY')], 'Matlab', ['class' => 'form-control']) !!}
					</div>
					<div class="form-group {!! ($errors->has('experiment_id')) ? 'has-error' : '' !!}">
						...
						{!! Form::select("experiment_id", [], null, ['class' => 'form-control']) !!}
					</div>
					<div class="form-group {!! ($errors->has('filename')) ? 'has-error' : '' !!}">
						{!! Form::label("filename", trans('controller::default.CTRL_UPLOAD_FILE'), ["class" => "control-label"]) !!}
