...
$("document").ready(function() {
	$("table.reports tbody").load(ROOT_PATH + "includes/modules/report/loaddata.php?action=get_rows");
	
	$.get(ROOT_PATH + "includes/modules/report/loaddata.php?action=row_count", function(data) {
...
function generateRows(selected) {
	...
	if(pages <= 1){
		...
		$(".pagor").click(function() {
			...
			$("table.reports tbody").load(ROOT_PATH + "includes/modules/report/loaddata.php?action=get_rows&start=" + index);
...
function updatePage(elem) {
	...
	$("table.reports tbody").load(ROOT_PATH + "includes/modules/report/loaddata.php?action=get_rows&start=" + (selected - 1));
